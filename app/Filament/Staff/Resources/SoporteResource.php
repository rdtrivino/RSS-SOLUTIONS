...
class SoporteResource extends Resource
{
    ...
    {
        return [
            'index' => \App\Filament\Staff\Resources\SoporteResource\Pages\ListSoportes::route('/'),
            'view'  => \App\Filament\Staff\Resources\SoporteResource\Pages\ViewSoporte::route('/{record}'),
        ];
    }
